...
// : - ancho 2
static const char FP_DOS_PUNTOS[9][3] = {
    "00",
    "11",
    "11",
    "00",
...
// . - ancho 2
static const char FP_PUNTO[9][3] = {
    "00",
    "00",
    "00",
    "00",
...
static tCaracter7x9 obtener_caracter_7x9(char caracter)
{
    ...
    switch(caracter)
    {
        case 'A': case 'a': car.matriz = (const void*)FP_A;
                            car.ancho = FP_A_ANCHO;
                            break;
        case 'B': case 'b': car.matriz = (const void*)FP_B;
                            car.ancho = FP_B_ANCHO;
                            break;
        case 'C': case 'c': car.matriz = (const void*)FP_C;
                            car.ancho = FP_C_ANCHO;
                            break;
        case 'D': case 'd': car.matriz = (const void*)FP_D;
                            car.ancho = FP_D_ANCHO;
                            break;
        case 'E': case 'e': car.matriz = (const void*)FP_E;
                            car.ancho = FP_E_ANCHO;
                            break;
        case 'F': case 'f': car.matriz = (const void*)FP_F;
                            car.ancho = FP_F_ANCHO;
                            break;
        case 'G': case 'g': car.matriz = (const void*)FP_G;
                            car.ancho = FP_G_ANCHO;
                            break;
        case 'H': case 'h': car.matriz = (const void*)FP_H;
                            car.ancho = FP_H_ANCHO;
                            break;
        case 'I': case 'i': car.matriz = (const void*)FP_I;
                            car.ancho = FP_I_ANCHO;
                            break;
        case 'J': case 'j': car.matriz = (const void*)FP_J;
                            car.ancho = FP_J_ANCHO;
                            break;
        case 'K': case 'k': car.matriz = (const void*)FP_K;
                            car.ancho = FP_K_ANCHO;
                            break;
        case 'L': case 'l': car.matriz = (const void*)FP_L;
                            car.ancho = FP_L_ANCHO;
                            break;
        case 'M': case 'm': car.matriz = (const void*)FP_M;
                            car.ancho = FP_M_ANCHO;
                            break;
        case 'N': case 'n': car.matriz = (const void*)FP_N;
                            car.ancho = FP_N_ANCHO;
                            break;
        case 'O': case 'o': car.matriz = (const void*)FP_O;
                            car.ancho = FP_O_ANCHO;
                            break;
        case 'P': case 'p': car.matriz = (const void*)FP_P;
                            car.ancho = FP_P_ANCHO;
                            break;
        case 'Q': case 'q': car.matriz = (const void*)FP_Q;
                            car.ancho = FP_Q_ANCHO;
                            break;
        case 'R': case 'r': car.matriz = (const void*)FP_R;
                            car.ancho = FP_R_ANCHO;
                            break;
        case 'S': case 's': car.matriz = (const void*)FP_S;
                            car.ancho = FP_S_ANCHO;
                            break;
        case 'T': case 't': car.matriz = (const void*)FP_T;
                            car.ancho = FP_T_ANCHO;
                            break;
        case 'U': case 'u': car.matriz = (const void*)FP_U;
                            car.ancho = FP_U_ANCHO;
                            break;
        case 'V': case 'v': car.matriz = (const void*)FP_V;
                            car.ancho = FP_V_ANCHO;
                            break;
        case 'W': case 'w': car.matriz = (const void*)FP_W;
                            car.ancho = FP_W_ANCHO;
                            break;
        case 'X': case 'x': car.matriz = (const void*)FP_X;
                            car.ancho = FP_X_ANCHO;
                            break;
        case 'Y': case 'y': car.matriz = (const void*)FP_Y;
                            car.ancho = FP_Y_ANCHO;
                            break;
        case 'Z': case 'z': car.matriz = (const void*)FP_Z;
                            car.ancho = FP_Z_ANCHO;
                            break;
        case '0': car.matriz = (const void*)FP_0;
                  car.ancho = FP_0_ANCHO;
                  break;
        case '1': car.matriz = (const void*)FP_1;
                  car.ancho = FP_1_ANCHO;
                  break;
        case '2': car.matriz = (const void*)FP_2;
                  car.ancho = FP_2_ANCHO;
                  break;
        case '3': car.matriz = (const void*)FP_3;
                  car.ancho = FP_3_ANCHO;
                  break;
        case '4': car.matriz = (const void*)FP_4;
                  car.ancho = FP_4_ANCHO;
                  break;
        case '5': car.matriz = (const void*)FP_5;
                  car.ancho = FP_5_ANCHO;
                  break;
        case '6': car.matriz = (const void*)FP_6;
                  car.ancho = FP_6_ANCHO;
                  break;
        case '7': car.matriz = (const void*)FP_7;
                  car.ancho = FP_7_ANCHO;
                  break;
        case '8': car.matriz = (const void*)FP_8;
                  car.ancho = FP_8_ANCHO;
                  break;
        case '9': car.matriz = (const void*)FP_9;
                  car.ancho = FP_9_ANCHO;
                  break;
        case ':': car.matriz = (const void*)FP_DOS_PUNTOS;
                  car.ancho = FP_DOS_PUNTOS_ANCHO;
                  break;
        case '-': car.matriz = (const void*)FP_GUION;
                  car.ancho = FP_GUION_ANCHO;
                  break;
        case '.': car.matriz = (const void*)FP_PUNTO;
                  car.ancho = FP_PUNTO_ANCHO;
                  break;
        case '<': car.matriz = (const void*)FP_MENOR;
                  car.ancho = FP_MENOR_ANCHO;
                  break;
        case '>': car.matriz = (const void*)FP_MAYOR;
                  car.ancho = FP_MAYOR_ANCHO;
                  break;
        case '+': car.matriz = (const void*)FP_MAS;
                  car.ancho = FP_MAS_ANCHO;
                  break;
        case '/': car.matriz = (const void*)FP_BARRA;
                  car.ancho = FP_BARRA_ANCHO;
                  break;
        case '%': car.matriz = (const void*)FP_PORCENTAJE;
...
static void dibujar_caracter_7x9(char caracter, uint16_t x, uint16_t y, uint8_t color)
{
    ...
    const char *datos = (const char *)car.matriz;
    for(fila = 0; fila < F79_ALTO; fila++){
        for(col = 0; col < car.ancho; col++)
        {
            if(datos[fila * (car.ancho + 1) + col] == '1')
            {
